...
export function Login() {
  ...
  async function handleVerify(e: FormEvent) {
    ...
    try {
      ...
      const me = await signIn(res.accessToken, res.refreshToken);
      if (!me) {
        setError("This account doesn't have staff access. Ask an admin to assign you to a venue.");
        setStep("phone");
        setCode("");
        return;
      }
  ...
  return (
    <div className="center-screen">
      <div className="login-card stack">
        <div className="brand-mark">K-Meets Staff</div>
        <p style={{ textAlign: "center", marginBottom: 20 }}>
          Sign in with the phone number your K-Meets account uses.
        </p>
